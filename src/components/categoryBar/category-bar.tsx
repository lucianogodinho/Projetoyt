...
function CategoryBar() {
  ...
  const categoryButtons = [
    ...
    {name: 'História das civilizações', id: '18'},
    {name: 'Ciências', id: '28'},
    {name: 'Viagens pelo mundo', id: '41'},
    {name: 'Séries', id: '32'},
    {name: 'Novidades', id: '35'},
    {name: 'Educação', id: '32'}, 
    {name: 'Ciência e tecnologia', id: '28'}, 
    {name: 'Documentários', id: '32'}, 
    {name: 'Economia', id: '37'}, 
    {name: 'Investimentos e finanças', id: '47'}, 
    {name: 'Moda e estilo', id: '11'},
    {name: 'Comunicação', id: '13'},
    {name: 'Beleza', id: '18'},
  ];
